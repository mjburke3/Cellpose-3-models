...
### 3\. `40X\_Liver\_Nuclei\_UnmixColors\_V20`
...
model = models.CellposeModel(pretrained\_model='path/to/10X\_DAPI\_Muscle\_Nuc\_V10')

# Load and run on an image
img = io.imread('your\_image.tif')
masks, flows, styles = model.eval(img, channels=\[0, 0])
```

### Preprocessing for `40X\_Liver\_Nuclei\_UnmixColors\_V20`
...
* Stirling DR, Swain-Bowden MJ, Lucas AM, Carpenter AE, Cimini BA, Goodman A. CellProfiler 4: improvements in speed, utility and usability. BMC Bioinformatics 22, 433 (2021).
